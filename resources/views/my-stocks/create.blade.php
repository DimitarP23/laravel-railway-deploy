    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('my-stocks.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="error_code" class="form-label">Stock Code</label>
                            <input type="number" name="error_code" id="error_code" class="form-control @error('error_code') is-invalid @enderror" value="{{ old('error_code') }}" required>
                            @error('error_code')
                        ...
                        <div class="mb-3">
                            ...
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Add details about this stock investment</div>
                        </div>
